...
- 用户工作区：1920×1080、1440×1000、1280×900、375×812 与 1440px 侧栏折叠态通过；个人资料弹窗的 1440×1000、1280×900、375×812 专项验收通过。
- 管理中心：1920×1080、1440×1000、1280×900、375×812 与 1440px 侧栏折叠态通过。
- 登录：1920×1080、1440×1000、1280×900、375×812 通过；403、404：1440×1000、1280×900、375×812 通过。
- 浏览器验收场景：23/23 通过。
- 根节点横向溢出：0 个失败页面。
- 浏览器控制台错误：0。
...
- `user-shell-1280.png`
- `user-shell-375.png`
- `user-shell-collapsed-1440.png`
- `user-profile-1440.png`
- `user-profile-1280.png`
- `user-profile-375.png`
- `admin-shell-1440.png`
- `admin-shell-1920.png`
- `admin-shell-1280.png`
- `admin-shell-375.png`
- `admin-shell-collapsed-1440.png`
- `login-1440.png`
- `login-1920.png`
- `login-1280.png`
- `login-375.png`
